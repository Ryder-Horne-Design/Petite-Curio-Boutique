...
export default function LinkButton(props: {
  ...
  return (
    <Link href={props.href} className="border-2 bg-transparent px-3 py-1 border-yellow-500 rounded-md text-yellow-500 fill-yellow-500 group transition-colors duration-300 hover:border-white hover:bg-yellow-500 hover:text-white hover:fill-white focus-visible:border-white focus-visible:bg-yellow-500 focus-visible:text-white focus-visible:fill-white">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" className="inline-block align-middle" role="presentation" width="18" height="18" viewBox="0 0 18 18" fill="none">
        ...
        <path className="transition-[stroke-dashoffset,transform] [stroke-dashoffset:10] [stroke-dasharray:10] duration-300 translate-x-0.5 group-hover:translate-x-1.5 group-hover:[stroke-dashoffset:20] group-focus-visible:translate-x-1.5 group-focus-visible:[stroke-dashoffset:20]" strokeDashoffset={10} strokeDasharray={10} stroke="currentColor" d="M1.75 8H11" strokeWidth={1.5} strokeLinecap="round" />
      </svg>
    </Link>
  );
};